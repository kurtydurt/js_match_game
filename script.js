...
function createCards(parentElement, shuffledImageClasses) {
  ...
  for (let i = 0; i < 12; i ++) {
    newCard = appendNewCard(parentElement);
    newCard.classList.add(shuffledImageClasses[i]);
    cardHolder.push({"index" : i, "element" : newCard, "imageClass" : shuffledImageClasses[i]});
  }
...
newlyFlippedCard.element.classList.add("border-glow");   lastCardFlipped.element.classList.add("border-glow");
